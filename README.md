<div align="center">
  ...
  <p>
    <img src="https://img.shields.io/badge/version-0.21.0-6366f1?style=flat-square" alt="Version 0.21.0" />
...
- **Ecosystem-Specific Presets:** Curated, battle-tested presets for Modern Angular (Signals, Zoneless, OnPush, inject(), Tailwind), React 19 (Vite, Tailwind, Zustand, TanStack Query, Zod), React Native & Expo (Expo Router, NativeWind, FlashList, Reanimated), Python AI, Go, Rust, and Java Spring Boot.
